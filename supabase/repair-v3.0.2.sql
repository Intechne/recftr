...
CREATE TABLE IF NOT EXISTS applications (
  id SERIAL PRIMARY KEY, num TEXT NOT NULL, team TEXT NOT NULL, org TEXT NOT NULL, city TEXT NOT NULL, district TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS teams (
  id SERIAL PRIMARY KEY, num TEXT NOT NULL UNIQUE, name TEXT NOT NULL, school TEXT NOT NULL, city TEXT NOT NULL, district TEXT NOT NULL DEFAULT '',
