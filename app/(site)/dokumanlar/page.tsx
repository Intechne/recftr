...
export default function DokumanlarPage(){
  ...
  return <div className="pb-20"><PageHead kicker="BİLGİ MERKEZİ" title="DOKÜMANLAR" sub="Sezon dokümanları, teknik dokümantasyon, koç kaynakları ve marka kiti — tek yerde."/><div className="mx-auto max-w-7xl px-5 lg:px-10">
