...
const PUBLIC=["site_name","hero_title","hero_description","hero_image","ticker","contact_team","contact_info","contact_phone","instagram","youtube","linkedin","maintenance","site_logo","site_mark","favicon_url","apple_touch_icon_url","og_image"];
